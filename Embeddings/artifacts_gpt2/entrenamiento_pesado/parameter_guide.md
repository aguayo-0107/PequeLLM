...
- `head_dim`: `32`
- `head_dim_range`: `ok`
- `token_embedding_params`: `50331648`
- `token_embedding_memory_mb_fp32`: `192.00`
- `token_embedding_memory_mb_fp16`: `96.00`
...
```json
{
  ...
  "checkpoint_path": "C:\\Repos\\PequeLLM\\pequellm_pesado_checkpoint.pth",
